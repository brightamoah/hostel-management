            ...
            <div class="authentication-inner">
                <div class="card px-sm-6 px-0">
                    <div class="card-body">
                        ...
                        <p class="mb-6 text-center">Enter your new password</p>
                        <?php
                        if (isset($_SESSION['message-reset'])) {
                            ...
                            unset($_SESSION['message-reset']);
                            unset($_SESSION['message_type']);
                        }
                        ?>
                        <form id="formAuthentication" class="mb-6" action="<?php echo htmlspecialchars($url); ?>" method="POST">
                            <?php set_csrf(); ?>
                            <input type="hidden" name="token" value="<?php echo htmlspecialchars($token); ?>">


                            <div class="mb-6 position-relative form-password-toggle form-control-validation">
                            ...
                            <input value="Reset Password" type="submit" class="btn btn-primary d-grid w-100">
                        </form>
