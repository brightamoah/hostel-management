...
<head>
   ...
   <link rel="stylesheet" href="../../assets/css/perfect-scrollbar/perfect-scrollbar.css" />

   <!-- endbuild -->

   <!-- Vendor -->
   <link rel="stylesheet" href="../../assets/css/@form-validation/form-validation.css" />
      ...
      <div class="authentication-inner row m-0">
         ...
         <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center p-5">
            <div class="w-100 d-flex justify-content-center">
               <img src="../../assets/img/boy-with-rocket-light.png" class="img-fluid" alt="Login image" width="700"
               ...
               <form id="formAuthentication" class="mb-6" action="login" method="post">
                  <div class="mb-6 form-control-validation">
                     ...
                     <input type="text" class="form-control" id="email" name="email"
                        placeholder="Enter your email or username" autofocus autocomplete="email" />
                  </div>
