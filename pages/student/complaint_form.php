...
$total_complaints = count($result = $complainModel->getComplaintsByStudent($student_id)['data']);



$pending_complaints = $complainModel->getPendingComplaint($student_id);



$in_progress_complaints = $complainModel->getInProgressComplaint($student_id);
$resolved_complaints = $complainModel->getResolvedComplaint($student_id);

// Fetch rooms for modal dropdown
$rooms = $conn->query("SELECT room_id, room_number, building FROM rooms ORDER BY building, room_number")->fetch_all(MYSQLI_ASSOC);
?>
...
<head>
    ...
    <title>Kings Hostel - Complaints</title>
    <meta name="description" content="Submit and manage your hostel complaints" />
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center mb-2">
                                            <div class="avatar me-4">
                                                <span class="avatar-initial rounded bg-label-primary"><i class="bx bx-message-alt-dots icon-lg"></i></span>
                                            </div>
                            ...
                            <div class="card-body">
                                <div class="row mb-4">
                                    <!-- <div class="col-md-4 mb-3 mb-md-0">
                                        <input type="text" id="complaintSearch" class="form-control" placeholder="Search complaints...">
                                    </div> -->
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form id="newComplaintForm">
                                        ...
                                        <div class="mb-3">
                                            <label for="roomId" class="form-label">Room (Optional)</label>
                                            <select id="roomId" name="room_id" class="form-select">
                                                <option value="">Select Room (if applicable)</option>
                                                <?php foreach ($rooms as $room): ?>
                                                    <option value="<?= $room['room_id'] ?>">
                                                        <?= htmlspecialchars($room['room_number'] . ' - ' . $room['building']) ?>
                                                    </option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea id="description" name="description" class="form-control" rows="4" required placeholder="Describe your issue..."></textarea>
                                        </div>
                                        <div class="mb-3">
                        ...
                        <div class="modal-dialog modal-lg modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header bg-primary">
                                    <h5 class="modal-title mb-2 text-white" id="complaintDetailsModalLabel">Complaint Details</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                        ...
                                        <div class="col-12">
                                            <div class="card">
                                                ...
                                                <div class="card-body pt-3">
                                                    ...
                                                    <div id="complaintTimeline" class="timeline mt-4">
                                                        <!-- Submission event -->
                                                        <div class="timeline-item ">
                                                            ...
                                                            <div class="timeline-event">
                                                                ...
                                                                <p class="mb-2">Your complaint has been registered in our system.</p>
                                                            </div>
                                                        </div>
