            ...
            <div class="modal-body">
                <form id="createInvoiceForm" class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" step="0.01" class="form-control" id="amountInput" name="amount" placeholder="Enter amount" required>
                    </div>
                    <div class="col-md-6">
                        <label for="dueDateInput" class="form-label">Due Date</label>
                        <input type="text" class="form-control flatpickr-date" id="dueDateInput" name="date_due" placeholder="Select due date" required>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <select id="academicPeriod" name="academic_period" class="form-select">
                            ...
                            <option value="2026_spring">Spring 2026</option>
                        </select>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-12">
                        ...
                        <textarea class="form-control" id="invoiceDescription" name="description" rows="3" placeholder="Enter invoice description or additional details" required></textarea>
                    </div>
                    <div class="col-12">
