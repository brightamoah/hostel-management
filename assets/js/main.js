      ...
      getSources() {
         ...
         if (data.navigation) {
            ...
            const navigationSources = Object.keys(data.navigation)
               .filter(
                  (section) => section !== "files" && section !== "members"
               )
               .map((section) => ({
                  ...
                  templates: {
                     header({ items, html }) {
                        ...
                        return html`
                           <span class="search-headings">${section}</span>
                        `;
                     },
                     item({ item, html }) {
                        return html`
               ...
               sources.push({
                  ...
                  templates: {
                     header({ items, html }) {
                        if (items.length === 0) return null;
                        return html`
                           <span class="search-headings">Files</span>
                        `;
                     },
                     item({ item, html }) {
                        return html`
               ...
               sources.push({
                  ...
                  templates: {
                     header({ items, html }) {
                        if (items.length === 0) return null;
                        return html`
                           <span class="search-headings">Members</span>
                        `;
                     },
                     item({ item, html }) {
                        return html`
